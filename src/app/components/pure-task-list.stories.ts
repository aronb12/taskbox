...
Default.args = {
  tasks: [
    ...
    { ...TaskStories.Default.args.task, id: '3', title: 'Task Three' },
    { ...TaskStories.Default.args.task, id: '4', title: 'Task Four' },
    { ...TaskStories.Default.args.task, id: '5', title: 'Task Five' },
    { ...TaskStories.Default.args.task, id: '6', title: 'Task Six' },
  ],
};
